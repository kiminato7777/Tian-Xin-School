...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function collectFormData() {
        ...
        return {
            ...
            englishLastName: document.getElementById('reg_englishLastName') ? document.getElementById('reg_englishLastName').value.trim() || '' : '',
            englishFirstName: document.getElementById('reg_englishFirstName') ? document.getElementById('reg_englishFirstName').value.trim() || '' : '',
    ...
    function populateFormForEdit(data) {
        ...
        if (document.getElementById('reg_englishLastName')) document.getElementById('reg_englishLastName').value = data.englishLastName || '';
        if (document.getElementById('reg_englishFirstName')) document.getElementById('reg_englishFirstName').value = data.englishFirstName || '';
