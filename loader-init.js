/* loader-init.js */
(function () {
    // Inject the loader HTML when the script is loaded
    const loaderHtml = `
        <div id="universal-loader">
            <div class="loader-content">
                ...
                <div class="loader-text">កំពង់ទាញទិន្នន័យ... ចាំបន្តិចណា</div>
            </div>
        </div>
    `;


    // Insert as the first child of body if body exists, otherwise wait for it
    ...
    window.addEventListener('load', function () {
        setTimeout(window.hideUniversalLoader, 800);
    });

    // Fallback hide after 5 seconds just in case
    setTimeout(() => {
